export const nbTranslation = {
  ...
  favorites: {
    ...
    advanced: 'Avansert',
    yearRange: 'Årsperiode',
    clearYear: 'Tøm årsfilter',
    noFilterResults: 'Ingen favoritter matcher de valgte filtrene.',
  ...
  albums: {
    ...
    advanced: 'Avansert',
    yearRange: 'Årsperiode',
    trackCount: 'Sporantall',
    trackCountAll: 'Alle',
    trackCountAlbum: 'Album',
    trackCountDouble: 'Dobbeltalbum',
    clearAdvanced: 'Tøm filtre',
  },
  artists: {
    title: 'Artister',
    search: 'Søk…',
  ...
  settings: {
    ...
    coverArtBackground: 'Omslagsbakgrunn',
    coverArtBackgroundSub: 'Vis uskarpe albumomslag som bakgrunn i album- og spillelisteoverskrifter. Slå av for en solid temabakgrunn.',
    playlistCoverPhoto: 'Spilleliste-omslagsbilde',
    playlistCoverPhotoSub: 'Vis omslagsbilde i overskriftene på spilleliste-detaljsiden.',
    showBitrate: 'Vis bitrate',
    showBitrateSub: 'Viser bitrate (kbps) i formatkolonnen i sanglister.',
