export const esTranslation = {
  ...
  favorites: {
    ...
    clearYear: 'Limpiar filtro de año',
    noFilterResults: 'Ningún favorito coincide con los filtros seleccionados.',
  ...
  albums: {
    ...
    advanced: 'Avanzado',
    yearRange: 'Rango de Años',
    trackCount: 'Cantidad de Pistas',
    trackCountAll: 'Todos',
    trackCountAlbum: 'Álbum',
    trackCountDouble: 'Álbum Doble',
    clearAdvanced: 'Limpiar filtros',
  },
  artists: {
    title: 'Artistas',
    search: 'Buscar…',
  ...
  settings: {
    ...
    uiScaleLabel: 'Zoom',
    coverArtBackground: 'Fondo de carátula',
    coverArtBackgroundSub: 'Muestra la carátula difuminada como fondo en los encabezados de álbumes y playlists. Desactiva para un fondo sólido del tema.',
    playlistCoverPhoto: 'Foto de portada de la playlist',
    playlistCoverPhotoSub: 'Muestra la foto de portada en los encabezados de la página de detalles de la playlist.',
    showBitrate: 'Mostrar bitrate',
    showBitrateSub: 'Muestra el bitrate (kbps) en la columna formato de las listas de canciones.',
  },
  changelog: {
  ...
  deviceSync: {
    ...
    colName: 'Nombre',
    colType: 'Tipo',
    syncResult: '{{done}} transferidos, {{skipped}} ya actualizados ({{total}} total)',
    deleteFromDevice: 'Eliminar del dispositivo ({{count}})',
