...
export const ruTranslation = {
  ...
  favorites: {
    ...
    clearYear: 'Сбросить фильтр года',
    noFilterResults: 'Нет избранного, соответствующего выбранным фильтрам.',
  ...
  albums: {
    ...
    trackCountAll: 'Все',
    trackCountAlbum: 'Альбом',
    trackCountDouble: 'Двойной альбом',
    clearAdvanced: 'Сбросить фильтры',
  },
  artists: {
    title: 'Исполнители',
    search: 'Поиск…',
  ...
  settings: {
    ...
    coverArtBackgroundSub: 'Показывать размытую обложку в качестве фона в заголовках альбомов и плейлистов. Отключите для сплошного фона темы.',
    playlistCoverPhoto: 'Обложка плейлиста',
    playlistCoverPhotoSub: 'Показывать обложку в заголовках страницы деталей плейлиста.',
    showBitrate: 'Показывать битрейт',
    showBitrateSub: 'Показывать битрейт (кбит/с) в колонке формата списков песен.',
