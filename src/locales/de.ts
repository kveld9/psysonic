export const deTranslation = {
  ...
  favorites: {
    ...
    clearYear: 'Jahresfilter zurücksetzen',
    noFilterResults: 'Keine Favoriten entsprechen den ausgewählten Filtern.',
  ...
  albums: {
    ...
    advanced: 'Erweitert',
    yearRange: 'Jahresbereich',
    trackCount: 'Track-Anzahl',
    trackCountAll: 'Alle',
    trackCountAlbum: 'Album',
    trackCountDouble: 'Doppelalbum',
    clearAdvanced: 'Filter zurücksetzen',
  },
  artists: {
    title: 'Künstler',
    search: 'Suchen…',
  ...
  settings: {
    ...
    themeSchedulerActiveHint: 'Der Theme-Planer ist aktiv – Theme-Änderungen werden automatisch verwaltet.',
    coverArtBackground: 'Cover-Hintergrund',
    coverArtBackgroundSub: 'Zeigt das verschwommene Cover als Hintergrund in Album- und Playlist-Headern an. Deaktivieren für einen einfarbigen Theme-Hintergrund.',
    playlistCoverPhoto: 'Playlist-Coverbild',
    playlistCoverPhotoSub: 'Zeigt das Coverbild in den Headern der Playlist-Detailseite an.',
    showBitrate: 'Bitrate anzeigen',
    showBitrateSub: 'Zeigt die Bitrate (kbps) in der Format-Spalte der Song-Listen an.',
    uiScaleTitle: 'Schnittstellen-Skalierung',
    uiScaleLabel: 'Zoom',
  },
  changelog: {
  ...
  deviceSync: {
    ...
    cleanupButton: 'Dateien außerhalb der Auswahl löschen',
    cleanupNothingToDelete: 'Nichts zu löschen — Gerät ist bereits synchronisiert.',
    confirmCleanup: '{{count}} Datei(en) vom Gerät löschen, die nicht in der aktuellen Auswahl sind. Fortfahren?',
    cleanupComplete: '{{count}} Datei(en) vom Gerät entfernt.',
