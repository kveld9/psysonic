export const nlTranslation = {
  ...
  favorites: {
    ...
    clearYear: 'Jaarfilter wissen',
    noFilterResults: 'Geen favorieten voldoen aan de geselecteerde filters.',
    showingCount: '{{filtered}} van {{total}} weergegeven',
  ...
  albums: {
    ...
    advanced: 'Geavanceerd',
    yearRange: 'Jaarbereik',
    trackCount: 'Aantal nummers',
    trackCountAll: 'Alle',
    trackCountAlbum: 'Album',
    trackCountDouble: 'Dubbel album',
    clearAdvanced: 'Filters wissen',
  },
  artists: {
    title: 'Artiesten',
    search: 'Zoeken…',
  ...
  settings: {
    ...
    coverArtBackground: 'Albumhoes-achtergrond',
    coverArtBackgroundSub: 'Toon vervaagde albumhoezen als achtergrond in album- en afspeellijstheaders. Schakel uit voor een effen thema-achtergrond.',
    playlistCoverPhoto: 'Playlist omslagfoto',
    playlistCoverPhotoSub: 'Toon omslagfoto in de headers van de playlist detailpagina.',
    showBitrate: 'Bitrate weergeven',
    showBitrateSub: 'Toont de bitrate (kbps) in de formaatkolom van nummerlijsten.',
