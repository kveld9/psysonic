export const enTranslation = {
  ...
  favorites: {
    ...
    noFilterResults: 'No favorites match the selected filters.',
  ...
  settings: {
    ...
    coverArtBackgroundSub: 'Show blurred cover art as background in album and playlist headers. Disable for a solid theme background.',
    playlistCoverPhoto: 'Playlist Cover Photo',
    playlistCoverPhotoSub: 'Show cover photo in playlist detail page headers.',
    showBitrate: 'Show Bitrate',
    showBitrateSub: 'Show bitrate (kbps) in the format column of song lists.',
