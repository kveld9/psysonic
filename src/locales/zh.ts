export const zhTranslation = {
  ...
  settings: {
    ...
    coverArtBackgroundSub: '在专辑和播放列表头部显示模糊的封面作为背景。关闭以使用纯色主题背景。',
    playlistCoverPhoto: '播放列表封面照片',
    playlistCoverPhotoSub: '在播放列表详情页头部显示封面照片。',
    showBitrate: '显示比特率',
    showBitrateSub: '在歌曲列表的格式列中显示比特率（kbps）。',
    uiScaleTitle: '界面缩放',
    uiScaleLabel: '缩放',
  },
  changelog: {
