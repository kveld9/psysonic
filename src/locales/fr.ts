export const frTranslation = {
  ...
  favorites: {
    ...
    clearYear: 'Effacer le filtre année',
    noFilterResults: 'Aucun favori ne correspond aux filtres sélectionnés.',
    showingCount: 'Affichage {{filtered}} sur {{total}}',
  ...
  albums: {
    ...
    trackCountDouble: 'Album double',
    clearAdvanced: 'Effacer les filtres',
  },
  artists: {
    title: 'Artistes',
    search: 'Rechercher…',
  ...
  settings: {
    ...
    themeSchedulerActiveHint: 'Le planificateur de thème est actif — les changements de thème sont gérés automatiquement.',
    coverArtBackground: 'Arrière-plan de pochette',
    coverArtBackgroundSub: 'Afficher la pochette floutée en arrière-plan des en-têtes d\'album et de playlist. Désactiver pour un arrière-plan de thème uni.',
    playlistCoverPhoto: 'Photo de couverture de la playlist',
    playlistCoverPhotoSub: 'Afficher la photo de couverture dans les en-têtes de la page de détails de la playlist.',
    showBitrate: 'Afficher le bitrate',
    showBitrateSub: 'Affiche le bitrate (kbps) dans la colonne format des listes de chansons.',
  ...
  deviceSync: {
    ...
    deleteFromDevice: 'Supprimer de l\'appareil ({{count}})',
    confirmDelete: 'Supprimer {{count}} élément(s) de l\'appareil : {{names}} ?',
    deleteComplete: '{{count}} élément(s) supprimé(s) de l\'appareil.',
